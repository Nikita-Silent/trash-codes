...
gantt
    ...
    section Подготовка
    1.1. Установка Zammad           :a1, 2025-10-02, 2d
    1.2. Настройка инфраструктуры   :a2, after a1, 1d
    1.3. Анализ требований          :a3, 2025-10-02, 2d
    section Настройка
...
gantt
    ...
    section Подготовка
    1.1. Анализ требований      :a1, 2025-10-02, 3d
...
```mermaid
graph LR
    subgraph Матрица рисков
    A[Высокая вероятность\nВысокое влияние] --> |Критические| B(Нехватка специалистов\nСбои интеграции)
    C[Низкая вероятность\nВысокое влияние] --> |Мониторить| D(Проблемы с API)
    E[Высокая вероятность\nНизкое влияние] --> |Контролировать| F(Сопротивление)
    end
```
